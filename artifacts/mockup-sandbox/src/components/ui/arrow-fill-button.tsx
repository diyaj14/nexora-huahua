...
const VARIANT_COLORS = {
  primary: {
    ...
    fillBgColor: "#b54926", // Signature terracotta copper ember
    fillTextColor: "#ffffff",
    hoverFillBgColor: "#b54926",
  ...
  copper: {
    bgColor: "#b54926", // Warm copper terracotta
    textColor: "#ffffff",
    fillBgColor: "#1b1614", // Deep charcoal timber
    fillTextColor: "#f6efe8",
    hoverFillBgColor: "#1b1614",
    hoverFillTextColor: "#f6efe8",
    arrowColor: "#f6efe8",
    hoverArrowColor: "#f6efe8",
  },
  accent: {
    bgColor: "#b54926",
    textColor: "#ffffff",
  ...
  quiet: {
    ...
    fillBgColor: "#b54926", // Warm terracotta fill on hover
    fillTextColor: "#ffffff",
    hoverFillBgColor: "#b54926",
    hoverFillTextColor: "#ffffff",
    arrowColor: "#ffffff",
...
export function ArrowFillButton({
  ...
  const baseClassName = `group relative inline-flex w-fit min-w-fit max-w-none cursor-pointer items-center justify-center overflow-hidden rounded-full border border-[var(--btn-bg)] whitespace-nowrap leading-none [text-rendering:geometricPrecision] shadow-xs ${
    usesUtilityBackground ? "" : "bg-[var(--btn-bg)]"
  } text-[var(--btn-text)] ${sizeClasses} ${className}`;
  ...
  const innerElements = (
    <>
      ...
      <div
        aria-hidden="true"
        className={`pointer-events-none absolute inset-0 z-2 flex items-center px-[inherit] pr-[inherit] text-[var(--btn-fill-text)] [clip-path:inset(var(--circle-inset-y)_var(--icon-right)_var(--circle-inset-y)_calc(100%-var(--icon-right)-var(--icon-circle)))] ${
          isReady
